---
title: Linux 内核学习笔记：操作系统结构
date: 2026-07-07 17:15:00 +0800
categories: [学习笔记, OS与Linux内核笔记]
tags: [Linux, Linux Kernel, Operating System, System Call, ELF]
---

这一篇记录操作系统结构里和 Linux 内核学习直接相关的部分：内核能力、用户态/内核态、系统调用、Linux 的多任务/SMP/ELF/宏内核设计，以及少量 Windows 内核对照。
